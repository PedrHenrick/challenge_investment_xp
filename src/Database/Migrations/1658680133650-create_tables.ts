...
export class create_tables1658680133650 implements MigrationInterface {
    name = 'create_tables1658680133650'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("client_code" SERIAL NOT NULL, "fullName" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "balance" numeric NOT NULL DEFAULT '0', CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_ba4251b9c1795115a73e9040116" PRIMARY KEY ("client_code"))`);
